...
const NewCourseCreateForm = ({ btnText, is_class, teachers, user }) => {
  ...
  const handleImageUpload = async () => {
    ...
    data.append("upload_preset", "yeepthf4");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = `${baseUrl}/api/courses/new_course`;
      ...
      if (is_class) {
        ...
        router.push(`/admin/courses/courses_new/`);
      }
    } catch (err) {
      // console.log(err);
      let {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="row">
        ...
        <div className="col-md-6">
          {/* <div className="form-group">
            <label className="form-label fw-semibold">Teachers</label>
            <select
              className="form-select"
              name="userID"
              value={course.userID}
...
export default NewCourseCreateForm;
